...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final List<String> categories = ['All', 'News', 'Politics', 'Business', 'Movies', 'Cricket', 'Technology', 'Economics', 'other'];
  ...
  getOnTheLoad() async {
    blogsStream = await BlogService().getAllBlogs();
  ...
  void searchBlogAndAuthor(String query) {
    ...
    searchQuery = query;
    setState(() {
      filteredBlogs = allExploreBlogs.where((doc) {
        String author = (doc["authorName"] ?? '').toLowerCase();
        String title = (doc["title"] ?? '').toLowerCase();
        String category = (doc["category"] ?? '').toLowerCase();

        bool matchesSearch = author.contains(query) || title.contains(query) || category.contains(query);
        bool matchesCategory = selectedCategory == 'All' || category == selectedCategory.toLowerCase();
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          ...
                          onPressed: () => searchBlogAndAuthor(searchController.text),
                        ),
                        filled: true,
